...
\Skill{1}{Charge}{\TIME{\X}}
{TODO: flavor: use momentum to put force behind an attack}
{Choose a Melee Attack action that takes exactly [\X] seconds. Once before the end of this turn, you may make the chosen attack. When you do, if the attack hits, add [$D / (6 - \X)$] to the damage of the attack, where $D$ is the distance between where you activated this skill and where you made the attack.}
...
{TODO: flavor: raw conduit of magic}
{TODO: unlock}
...
\Class{Noble}{\CHA/\KNO}
{TODO: flavor: money and connections}
{TODO: unlock}
...
\Class{Summoner}{\CHA/\WIL}
{TODO: flavor: needs a better name}
{TODO: unlock}
