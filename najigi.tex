...
Then, increase your Maximum Health based on the option you chose. If you chose to gain a level in a class, use that class's listed Maximum Health Increase. If you chose to gain points in your stats, use the value in the following list corresponding to the stat that you increased.
\begin{center}
