...
\item Noble (\CHA/\STR): money, connections
...
{Move a small object up to [\DEX] spaces in any direction, or move a large object up to [\DEX/2] spaces in any direction. TODO: dex save for characters}
