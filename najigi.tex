...
\begin{itemize}
\item Human: +1 to all stats
\item Dwarf: +2 to Brawn stats
\item Elf: +2 to Grace stats
\item Golem: +3 to Body stats
\item TODO: +3 to Mind stats
\item Fey: +3 to Soul stats
\end{itemize}
...
\Skill{TODO: 1 or 3}{Charge}{\TRIG{deal damage with a melee Attack}}
{TODO: flavor}
